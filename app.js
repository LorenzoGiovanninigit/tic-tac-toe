...
if(count%2 !==0){
    et.textContent="X";
    document.querySelector(".winner p").textContent="O player move";
}else{
    et.textContent="O";
    document.querySelector(".winner p").textContent="X player move";
}
   ...
   function checkWinner(){
       ...
       B=document.querySelector("#row-1 #two ").textContent;
        ...
        if((A===E&&E===I&&A!=="")||(B===E&&E===H&&B!=="")||(G===E&&E===C&&C!=="")||(D===E&&E===F&&F!=="")){winnerDec(`${E}'s player win!`);}

        if((A===D&&D===G&&A!=="")||(A===B&&B===C&&A!=="")){winnerDec(`${A}'s player win!`);}
